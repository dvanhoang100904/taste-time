                        ...
                        <?php foreach ($getAllBeveragesPage as $beverages) { ?>
                            <tr>
                                ...
                                <td class="d-flex justify-content-around ">
                                    <a href="show.php?beverage_id=<?= $beverages->getBeverageId() ?>?&page=<?= $page ?>" class="btn btn-sm btn-info">View</a>
                                    <a href="edit.php?beverage_id=<?= $beverages->getBeverageId() ?>?&page=<?= $page ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <a href="delete.php?beverage_id=<?= $beverages->getBeverageId() ?>&page=<?= $page ?>" onclick="return confirm('Có xác nhận xóa?')" class="btn btn-sm btn-danger">Delete</i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
