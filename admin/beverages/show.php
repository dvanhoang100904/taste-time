            ...
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex mt-2">
                        ...
                        <a href="delete.php?beverage_id=<?= $getBeveragesByBeverageId->getBeverageId() ?>&page=<?= $page ?>" class="btn btn-danger btn-lg ms-5 " onclick="return confirm('Có xác nhận xóa?')">
                            <i class="bi bi-trash"></i> Delete
                        </a>
                        <a href="read.php?&page=<?= $page ?>" class="btn btn-secondary btn-lg ms-5 ">
                            Cancel
                        </a>
                    </div>
                </div>
